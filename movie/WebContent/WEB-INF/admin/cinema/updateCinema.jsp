...
<div align="center">
	...
	<table class="table">
		<tr>
			<th align="right"> <a href="addTheater.mo?cinema_num=${getCinema.cinema_num}">상영관 추가</a></th>
			<th align="right"> <a href="updateAdmin.mo?cinema_num=${getCinema.cinema_num}">관리자 수정</a></th>
		</tr>
	</table>
	<table class="table">
		<tr>
