		...
		<tr>
				...
				<td>
					<a href="prod_content.mo?pnum=${pdto.pnum}">
						<img src="${pageContext.request.scheme}://${pageContext.request.serverName}:${pageContext.request.serverPort}${pageContext.request.contextPath}/images/${pdto.pimage}" width="40" height="40">
					</a>
				</td>
				<td>${pdto.pprice}</td>
				<td>${pdto.pqty}</td>
