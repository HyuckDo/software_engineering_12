	...
	<div align="center">
			<table class="class" width="99%">
				...
				<hr color="black" width="100%">
					...
					<tr>
						...
						<h4>예매횟수 <b>${mvdto.resercount}</b> | 관람평점 <b>${mvdto.score}</b></h4>
						</td>
			...
			<tbody>
				...
				<c:when test="${empty id}">
					<textarea cols="130" rows="5" name="review_content" disabled="disabled" placeholder="로그인하셔야 리뷰를 작성하실수 있습니다."></textarea>
				</td>
				<td>
