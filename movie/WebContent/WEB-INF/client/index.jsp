...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox" align="center">
    <div class="item active">
      <img src="images/taxidriver2.jpg" alt="시각장애인용 설명란" width="800" height="500">
      <div class="carousel-caption">
         아빠가.. 손님을 두고왔어..
      </div>
    </div>
    <div class="item">
      <img src="${pageContext.request.contextPath}/images/spider.jpg" alt="..." width="800" height="500">
      <div class="carousel-caption">
      </div>
    </div>
      <div class="item">
      <img src="images/superbad32.jpg" alt="..." width="800" height="500">
      <div class="carousel-caption">
      </div>
    </div>
    <div class="item">
      <img src="${pageContext.request.contextPath}/images/gunham.jpg" alt="..." width="800" height="500">
      <div class="carousel-caption">
      </div>
    </div>
  </div>
